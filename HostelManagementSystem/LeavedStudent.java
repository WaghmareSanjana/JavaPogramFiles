...
public class LeavedStudent extends javax.swing.JFrame {
    ...
    public LeavedStudent() {
        ...
        try{
            ...
            ResultSet rs=s.executeQuery("select *from student where status='leaved'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile", "Father Name", "Mother Name", "Email", "Address", "college", "Adhar No", "Room No"
            }
        ));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1070, 570));
